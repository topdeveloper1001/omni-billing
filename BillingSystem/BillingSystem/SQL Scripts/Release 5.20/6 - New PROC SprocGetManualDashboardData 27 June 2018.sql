IF OBJECT_ID('SprocGetManualDashboardData ','P') IS NOT NULL
	DROP PROCEDURE SprocGetManualDashboardData 
GO
...
--Exec SprocGetManualDashboardData  'IndicatorNumber','ASC',1016,0,1
CREATE Procedure [dbo].[SprocGetManualDashboardData]
(
	@pCID bigint=NULL,
	@pFID bigint=Null,
