IF EXISTS ( SELECT *
            FROM   sysobjects
            WHERE  id = object_id(N'SPROC_EncounterEndCheckBillEdit_VirtualDischarge')
                   and OBJECTPROPERTY(id, N'IsProcedure') = 1 )
         DROP PROCEDURE SPROC_EncounterEndCheckBillEdit_VirtualDischarge
GO

/****** Object:  StoredProcedure [dbo].[SPROC_EncounterEndCheckBillEdit_VirtualDischarge]    Script Date: 22-03-2018 19:44:25 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SPROC_EncounterEndCheckBillEdit_VirtualDischarge] 
(  
