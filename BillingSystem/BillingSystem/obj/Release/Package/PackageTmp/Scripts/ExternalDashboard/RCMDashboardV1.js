...
function BindRCMGraphsV1() {
    ...
    $.post("/ExternalDashboard/RCMGraphsDataV1", jsonData, function (data) {
        if (data != null && data != "") {
            //
            if (data.ipReveune != null && data.ipReveune.length > 2) {
                GraphsBuilderCustomSubTitleWithoutPercentage(data.ipReveune, 'myDashboardIPRevenue', "column", "Revenue  Inpatient", 3, 'By Month (000s)');
            } else {
                EmptyGraphsBuilderWithoutPercentageSubtitle('myDashboardIPRevenue', "column", "Revenue Daman", 3, 'By Month (000s)');
            }
            if (data.reveunePPD != null && data.reveunePPD.length > 2) {
                GraphsBuilderCustomSubTitleWithoutPercentage(data.reveunePPD, 'myDashboardRevenuePPD', "column", "Revenue Per Inpatient Day", 3, 'By Month');
            } else {
                EmptyGraphsBuilderWithoutPercentageSubtitle('myDashboardRevenuePPD', "column", "Revenue Per Inpatient Day", 3, 'By Month');
            }
            if (data.revenueDaman != null && data.revenueDaman.length > 2) {
                GraphsBuilderCustomSubTitleWithoutPercentage(data.revenueDaman, 'myDashboardRevenueDaman', "column", "Revenue Inpatient Daman", 3, 'By Month (000s)');
            } else {
                EmptyGraphsBuilderWithoutPercentageSubtitle('myDashboardRevenueDaman', "column", "Revenue Inpatient Daman", 3, 'By Month (000s)');
            }
            if (data.reveuneRoyalFamily != null && data.reveuneRoyalFamily.length > 2) {
                GraphsBuilderCustomSubTitleWithoutPercentage(data.reveuneRoyalFamily, 'myDashboardRevenueRoyalFamily', "column", "Revenue Inpatient Royal", 3, 'By Month (000s)');
            } else {
                EmptyGraphsBuilderWithoutPercentageSubtitle('myDashboardRevenueRoyalFamily', "column", "Revenue Inpatient Royal", 3, 'By Month (000s)');
            }
            if (data.reveuneInpatinetOther != null && data.reveuneInpatinetOther.length > 2) {
                GraphsBuilderCustomSubTitleWithoutPercentage(data.reveuneInpatinetOther, 'myDashboardRevenueInpatientOther', "column", "Revenue Inpatient ZMH", 3, 'By Month (000s)');
            } else {
                EmptyGraphsBuilderWithoutPercentageSubtitle('myDashboardRevenueInpatientOther', "column", "Revenue Inpatient ZMH", 3, 'By Month (000s)');
            }
            ...
            if (data.arDays != null && data.arDays.length > 0) {
                GraphsBuilderCustomSubTitleWithoutPercentage(data.arDays, 'myDashboardARDays', "column", "Net A/R Days", 3, 'By Month', 'Net A/R Days');
            } else {
                EmptyGraphsBuilderWithoutPercentage('myDashboardARDays', "column", "A/R Days", 1);
            }
            ...
            if (data.plannedDischarges != null && data.plannedDischarges.length > 2) {
                GraphsBuilderWithoutPercentage(data.plannedDischarges, 'myDashboardDischargesPlanned', "column", "Discharges Planned", 3);
            } else {
                EmptyGraphsBuilderWithoutPercentage('myDashboardDischargesPlanned', "column", "Discharges Planned", 3);
            }
            if (data.dischargesUnplanned != null && data.dischargesUnplanned.length > 2) {
                GraphsBuilderWithoutPercentage(data.dischargesUnplanned, 'myDashboardDischargesUnplannedAndExp', "column", "Discharges Unplanned & Exp", 3);
            } else {
                EmptyGraphsBuilderWithoutPercentage('myDashboardDischargesUnplannedAndExp', "column", "Discharges Unplanned & Exp", 3);
            }
            ...
            if (data.payorMix != null && data.payorMix.length > 0) {
                ...
                $('#myDashboardServiceCodeDistribution').empty();
