$(function () {
    ...
    $('#btnExportExcelData').click(function () {
        ...
        var hrefNew = controllerAction + "?month=" + monthval;
...
var BindExecutiveDashBoardlistV1 = function () {
    ajaxStartActive = false;
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: '/ExternalDashboard/ExecutiveDashboardFiltersV1',
...
var BuildGraphsSingleCall = function () {
    ...
    $.ajax({
        type: "POST",
        url: '/ExternalDashboard/ExecutiveDashboardGraphListV1',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: jsonData,
        asyc: true,
...
function ExecutveDashbordGraphsV1() {
    ...
    $.post("/ExternalDashboard/ExecutiveDashboardGraphListV1", jsonData, function (data) {
        if (data != null && data != "") {
            if (data.adcChart != null && data.adcChart.length > 2) {
                GraphsBuilderWithoutPercentage(data.adcChart, 'myDashboardADCMonthly', "column", "Average Daily Census", 1);
            } else {
            ...
            if (data.indirectNetRevenueChart != null && data.indirectNetRevenueChart.length > 2) {
                GraphsBuilderWithoutPercentageExecDashBoard(data.indirectNetRevenueChart, 'myDashboardIndirectCostNetRevenue', "column", "Indirect Costs as % of Net Revenue", 4);
            } else {
                EmptyGraphsBuilderWithoutPercentage('myDashboardIndirectCostNetRevenue', "column", "Indirect Costs as % of Net Revenue", 1);
            }
