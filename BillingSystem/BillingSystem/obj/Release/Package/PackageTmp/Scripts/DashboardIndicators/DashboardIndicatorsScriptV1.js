...
var chkSpecialCase = $("#chkSpecialCase").prop("checked") == true ? 1 : 0;
...
SpecialCase: chkSpecialCase
        });
        $.ajax({
            type: "POST",
            url: '/DashboardIndicators/SaveDashboardIndicatorsV1',
            async: false,
...
var chkSpecialCase = data.SpecialCase == 1 ? true : false;
    $("#chkSpecialCase").prop("checked", chkSpecialCase);
}
