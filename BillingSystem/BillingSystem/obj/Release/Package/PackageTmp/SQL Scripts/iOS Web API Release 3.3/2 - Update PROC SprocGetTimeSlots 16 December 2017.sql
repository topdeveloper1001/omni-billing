...
GO
/****** Object:  StoredProcedure [dbo].[SprocGetTimeSlots]    Script Date: 10/4/2017 5:30:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
-- =============================================
-- Exec [SprocGetTimeSlots] '','ATC',9,8,'','',10
-- Author:		<Author,,Name>
...
BEGIN
	...
	Begin
		Set @FTime = DATEADD(MINUTE,-1,CAST(@pTimeFrom as time))
		Set @TTime = DATEADD(MINUTE,1,CAST(@pTimeTill as time))
	End
	Else
	Begin
		Set @FTime = DATEADD(MINUTE,-1,CAST('07:00' as time))
		Set @TTime = DATEADD(MINUTE,1,CAST('16:00' as time))
	End
