IF EXISTS ( SELECT *
            FROM   sysobjects
            WHERE  id = object_id(N'SprocSaveAndApplyPayments')
                   and OBJECTPROPERTY(id, N'IsProcedure') = 1 )
         DROP PROCEDURE SprocSaveAndApplyPayments
GO

/****** Object:  StoredProcedure [dbo].[SprocSaveAndApplyPayments]    Script Date: 20-03-2018 16:17:23 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SprocSaveAndApplyPayments]
(
@pCId bigint,
@pFId bigint,
@pDateTime datetime,
