IF EXISTS ( SELECT *
            FROM   sysobjects
            WHERE  id = object_id(N'SPROC_GetReconcilationARPayorWise_Weekly')
                   and OBJECTPROPERTY(id, N'IsProcedure') = 1 )
         DROP PROCEDURE SPROC_GetReconcilationARPayorWise_Weekly
GO

/****** Object:  StoredProcedure [dbo].[SPROC_GetReconcilationARPayorWise_Weekly]    Script Date: 21-03-2018 11:14:16 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SPROC_GetReconcilationARPayorWise_Weekly]
(  
@pCorporateID int = 9,  
@pFacilityID int =8,
