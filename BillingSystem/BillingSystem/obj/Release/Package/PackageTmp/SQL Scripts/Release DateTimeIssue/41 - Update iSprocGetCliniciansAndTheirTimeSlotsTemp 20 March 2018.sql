IF EXISTS ( SELECT *
            FROM   sysobjects
            WHERE  id = object_id(N'iSprocGetCliniciansAndTheirTimeSlotsTemp')
                   and OBJECTPROPERTY(id, N'IsProcedure') = 1 )
        DROP PROCEDURE iSprocGetCliniciansAndTheirTimeSlotsTemp
GO

/****** Object:  StoredProcedure [dbo].[iSprocGetCliniciansAndTheirTimeSlotsTemp]    Script Date: 21-03-2018 10:15:28 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Exec [iSprocGetCliniciansAndTheirTimeSlots] 22
-- Author:		<Author,,Name>
-- Create date: <Create Date,,>
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[iSprocGetCliniciansAndTheirTimeSlotsTemp]
(
	@pFromDate nvarchar(50)='2017-12-19',
	@pToDate nvarchar(50)='2017-12-19',
