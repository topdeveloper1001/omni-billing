...
var popUpCal = {
    ...
    selectDate: function (Input) {
        ...
        if (this.timeSeparators && this.timeSeparators.length > 1) Input.val(this.formatDate(this.selectedMonth,this.selectedDay, this.selectedYear, this.selectedHour, this.selectedMinute));
        else Input.val(this.formatDate(this.selectedMonth,this.selectedDay, this.selectedYear));
    },
    ...
    showCalendar: function () {
        ...
        if (!this.changeYear) {
            ...
            if (years.length != 2) {
                ...
                year = this.selectedYear - 50;
                endYear = this.selectedYear + 10;
            }
            else if (years[0].charAt(0) == '+' || years[0].charAt(0) == '-') {
               
                year = this.selectedYear + (parseInt(years[0])-60);
    ...
    setupActions: function () {
        if (this.timeSeparators && this.timeSeparators.length > 1) {
            $('#calendar_hour').change(function () {	//change hour
                ...
                popUpCal.input.val(popUpCal.formatDate(popUpCal.selectedMonth,popUpCal.selectedDay, popUpCal.selectedYear, popUpCal.selectedHour, popUpCal.selectedMinute));
