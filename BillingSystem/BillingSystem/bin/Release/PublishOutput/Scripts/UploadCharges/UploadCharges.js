...
function ClearAll() {
    ...
    DisableCPTPanel(isMajorDRGEntered);
    $(".favdiag").hide();
}
...
function SetValueInDiagnosisType(isPrimary) {
    if (isPrimary != "True") {
        $(".ddlType1").val(2);
        $(".ddlType1").prop('disabled', 'disabled');
        //$("#CPTCodesInDiagnosisDiv").prop('disabled', false);      //Enable Major CPT Div
        $("#DRGCodesInDiagnosisDiv").prop('disabled', false);      //Enable DRG Div
    }
    else {
        $(".ddlType1").val(1);
        $(".ddlType1").attr('disabled', false);
        //DisableCPTPanel("False");
        //$("#CPTCodesInDiagnosisDiv").prop('disabled', 'disabled');      //Disable Major CPT Div
    ...
    var isMajorDRGEntered = $("#hdIsMajorDRGEntered").val();
    DisableDRGPanel(isMajorDRGEntered);
}
...
function DisableCPTPanel(isMajorCPT) {
    if (isMajorCPT == "False") {
        ...
        $("#txtCPTCode").prop("disabled", false);
    }
}
...
function DisableDRGPanel(isMajorDRG) {
    if (isMajorDRG == "False") {
        ...
        $("#lblMajorDRGInstruction").text("* You can search the CRG for the code or description.");
        $("#txtDRGCode").prop("disabled", false);
    }
}
