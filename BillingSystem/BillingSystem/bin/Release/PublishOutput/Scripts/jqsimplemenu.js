            ...
            return this.each(function () {
                ...
                $("li", menu).mouseenter(function () {
                    ...
                    if (isTopLevel) {
                        ...
                        box.stop(true, false).animate({ width: w, height: h }, 100, function () {
                            if ($(this).parent().find('ul:first').length == 0) {
                                timeoutInterval = setTimeout(function () {
                                    box.stop(true, false).animate({ height: '+=5' }, 100, function () {
                                        box.parent().find('ul:first').css('display', 'block').css('top', box.height()).stop(true, false).slideDown(speed);
                                    });
                                }, 10);
                            }
                            else {
                        ...
                        $(this).find('ul:first').css('display', 'block').stop(true, false).slideDown(speed);
                    }
                    ...
                    $(this).find('ul').slideUp(10, function () {
