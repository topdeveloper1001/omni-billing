...
/****** Object:  StoredProcedure [dbo].[SPROC_GetPatientBedInformation]    Script Date: 22-03-2018 16:26:52 ******/
SET ANSI_NULLS ON
GO
...
--Set @RetOutput = 'Bed Assigned:-' +isnull(@BedNumber,' ')+ ' Dated:-'+Cast(isnull(@AssignedSince,@CurrentDate) as nvarchar(20)) +' In Room:-'+isnull(@InRoom,' ')+' In Department:-'+Isnull(@InDepartment,' ')+' on Floor:-'+isnull(@OnFloor,' ')
