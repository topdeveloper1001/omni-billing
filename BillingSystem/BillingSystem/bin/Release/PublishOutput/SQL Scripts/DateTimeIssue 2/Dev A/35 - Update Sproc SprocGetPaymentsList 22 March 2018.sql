IF EXISTS ( SELECT *
            FROM   sysobjects
            WHERE  id = object_id(N'SprocGetPaymentsList')
                   and OBJECTPROPERTY(id, N'IsProcedure') = 1 )
         DROP PROCEDURE SprocGetPaymentsList
		 
		 GO

/****** Object:  StoredProcedure [dbo].[SprocGetPaymentsList]    Script Date: 3/22/2018 8:12:46 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SprocGetPaymentsList]
(
@pFId bigint,
