...
/****** Object:  StoredProcedure [dbo].[SprocGetPatientDetails]    Script Date: 3/22/2018 8:18:15 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	Select TOP 1 @EId=E.EncounterID, @EPatientType = EncounterPatientType, @EncounterAttendingPhysician = EncounterAttendingPhysician, @FId = EncounterFacilityID
