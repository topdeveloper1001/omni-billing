function SearchPatient() {
    ...
    if (isvalidSearch) {
        ...
        $.ajax({
            type: "POST",
            url: '/PatientSearch/GetPatientInfoSearchResult1',
            async: false,
            ...
            success: function (data) {
                ...
                $('#divSearchResult').html(data.facilityPatients);
                $('#divOtherFacility').empty();
                $('#divOtherFacility').html(data.otherfacilityPatients);
                $('#collapseOne').addClass('in');
                $('#collapseOthers').addClass('in');
