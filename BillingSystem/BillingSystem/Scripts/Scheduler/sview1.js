...
$(function () {
    ...
    */
    ...
    //setTimeout(InitializeScheduler(null, null), 500);
        ...
        .on("click", function () {
            ...
            if (schedulingType === "1") {
                ...
                if (isdivSchedulerDataValid && isdivAppointmentTypeProceduresValid) {
                    ...
                    if (clinicianUpdated && isMultipleType == "2") {
...
function InitializeScheduler(jsonData, physicianData, type) {
    /// <summary>
...
var SaveCustomSchedular = function () {
    ...
    if (selectedAppointmenttype != "") {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.IsError) {
                    if (data.booked.length > 0 && data.ErrorStatus != null && data.ErrorStatus == 2) {
                        unBlockRecurrenceDiv();
...
var ViewPatientScheduling = function (pid, pfirstname, plastname) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(jsonData),
        success: function (data) {
            InitializeScheduler(data.mainList, [], "1");
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data != null) {
                ...
                InitializeScheduler(data.savedSlots, [], "1");
