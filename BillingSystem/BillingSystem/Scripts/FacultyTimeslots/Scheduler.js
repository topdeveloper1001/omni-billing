...
$(function () {
    ...
    What: Taken All individual Ajax Requests into single request.
    Why: Optimization
    */
    //####################Changes as of 14th March, 2016 START here #########################

    //BindAppointmentAvailability();      //1
    //BindFacility("#ddFacility");        //2
    //BindFacility("#selOVFacility");//Overview popup     //2
    //BindGlobalCodesWithValue("#ddSpeciality", 1121, "");    //3
    //BindGlobalCodesWithValueOrderBy("#ddMonthWeekDays", 901, ""); //4
    //GetSchedularData();
    //BindLocationsInSchedular();
    //BindCorporatePhysician();
    //BindSchedulingStatus();
    //setTimeout(IntializeScheduler(null, null), 500);
    //BindCountryDataWithCountryCode("#ddlPatientCountries", "#hfPatientCountry", "#lblPatientCountryCode");


    BindAllSchedularData();

    //####################Changes as of 14th March, 2016 END here #########################
...
var BindSchedularWithFilters = function (physicianIds, statusfilter, deptIds, roomIds) {
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/GetSchedulerDataUpdated",   //GetSchedularWithFilters  //GetSchedulerDataUpdated
        async: true,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(jsonData),
        success: function (data) {
            IntializeScheduler(data, physicianData, "1");
...
var BindSchedularWithDeptFilters = function (phySlected, deptIds, statusfilter) {
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/GetSchedulerDataUpdated",
        async: true,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(jsonData),
...
var SetDepartmentAndSpeciality = function (e) {
    ...
    //if (fId > 0)
    //    BindLocationDataInScheduler(fId, false, true);

    //$("#ddFacility").val(fid);
    // -- no need of this method here
    //----Commented by Shashank on 19th May 2016
    // BindFacilityDepartments();
...
function AddAppointmentTypesTimeSlot() {
    ...
    html += "<td><input id='date" +
        apptTypeValue +
        "' type='text' class='validate[required]'/><input type='button' id='btnShowTimeSlots' class='btn btn-sm btn-primary marginLR10' style='height:28px;' value='View Slots' onclick='OnChangeAppointmentDate(this," +
        apptTypeValue +
        ")'/></td>";
...
var SaveCustomSchedular = function () {
    ...
    if (selectedAppointmenttype != "") {
            ...
            if (appointmenttypeArrayVal.length > 1) {
                ...
                */
                ...
                jsonData[0] = ({
                    ...
                    //Status: ($('#aptAvail' + selectedAppointmenttype).val()), //$('#ddAvailability').val(),
            ...
            for (var i = 0; i < appointmenttypeArray.length; i++) {
                ...
                */
                ...
                jsonData[i] = ({
                    ...
                    SchedulingType: $("#hidSchedulingType").val(),
                    Status: $("#ddAvailability").val(),
                    // ($('#aptAvail' + appointmenttypeobj).val()), //$('#ddAvailability').val(),
                    StatusType: "", //$('#ddAvailability').val(),
                    ScheduleFrom: scheFromDate,
                    ScheduleTo: scheToDate,
                    ...
                    RecurringDateTill: recDateTo,
                    //recuranceArrayObj.end_By, //isRecurranceMultiple ? recuranceArrayObj.end_By : null,
                    //EventId: id,
                    RecType: isRecurranceMultiple ? recuranceArrayObj.Rec_Type : null,
                    //recuranceArrayObj.Rec_Type, // isRecurranceMultiple ? recuranceArrayObj.Rec_Type : null,
                    RecPattern: isRecurranceMultiple ? recuranceArrayObj.Rec_Pattern : null,
                    // recuranceArrayObj.Rec_Pattern, //isRecurranceMultiple ? recuranceArrayObj.Rec_Pattern : null,
                    RecEventlength: recEventLength,
        ...
        $.ajax({
            type: "POST",
            url: "/FacultyTimeslots/SaveAppointment",  //SavePatientSchedulingUpdated
            async: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: jsonD,
        ...
        case "1":
            ...
            for (var i = 0; i < aptObj.length; i++) {
                ...
                html += "<td><input id='date" +
                    ...
                    "' class='validate[required]'/><input type='button' id='btnShowTimeSlots'  class='btn btn-sm btn-primary marginLR10' value='View Slots' onclick='OnChangeAppointmentDate(this," +
                    aptObj[i].TypeOfProcedureId +
                    ")'/></td><input type='hidden' id='hfTypeOfProcedureId" +
                    aptObj[i].TypeOfProcedureId +
                    "'  value='" +
...
//            } else if (data.avialableTimeslotListing[0].TimeSlot == 1) {
//                _ctrl = $("#ulTimeSlots");
//                _ctrl.html("");
//                _ctrl.html("<li class='alert alert-danger'>Rooms Not available for selected appointment type.</li>");
//            } else if (data.avialableTimeslotListing[0].TimeSlot == 2) {
//                _ctrl = $("#ulTimeSlots");
//                _ctrl.html("");
...
//                    html += '<li id="' +
//                        data.avialableTimeslotListing[i].TimeSlot +
//                        '" dopd="' +
//                        data.deptOpeningDays +
...
var ViewPatientScheduling = function (pid, pfirstname, plastname) {
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/GetPatientSchedulingUpdated",
        async: false,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(jsonData),
...
function ShowOverViewData() {
    ...
    if (isValid == true) {
        ...
        var searchUrl = "/FacultyTimeslots/GetOverView?FromDate=" +
            fromDate +
            "&ToDate=" +
            endDate +
            "&FromTime=" +
...
function BindAllSchedularData() {
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/GetAllSchedulingData",
        async: true,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify({
        ...
        success: function (data) {
            if (data != null) {
                ...
                BindCountryCodeData("#ddlPatientCountries",
                    "#hfPatientCountry",
                    "#lblPatientCountryCode",
                    data.countries);
...
function OnPhysicianSelectionInPreviousEncounters(facilityId, physicianId, departmentId, specialityId) {
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/OnPhysicianSelectionFromPreviousEncountersList",
        async: true,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify({
...
function OnChangeFacilityDropdownInAppointmentsOverview(facilityDropdownSelector, physicianId) {
    ...
    $.ajax({
        type: "POST",
        url: "/FacultyTimeslots/OnChangeFacilityDropdownInAppointmentsOverview",
        async: true,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify({
...
var BindPhyPreviousVacations = function () {
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/GetPhyPreviousVacations",
        async: false,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(jsonData),
...
function BindLocationDataInScheduler(fId, physiciansRequired, depsRequired) {
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/BindLocationDataInScheduler",
        async: false,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function GetDataOnPhysicianSelection(facilityId, physicianId, departmentId, specialityId) {
    $.ajax({
        type: "POST",
        url: "/FacultyTimeslots/GetAllDataOnPhysicianSelection",
        async: true,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        cache: false,
...
function BindSchedularDataByDeparment(physicianIds, statusfilter, deptIds, roomIds) {
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/GetFilteredSchedulerData",
        async: true,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(jsonData),
...
var BindHolidayView = function () {
    ...
    $.ajax({
        cache: false,
        type: "POST",
        url: "/FacultyTimeslots/GetFacilityHolidays",
        async: false,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(jsonData),
...
//        cache: false,
//        type: "POST",
//        url: "/FacultyTimeslots/DeleteHoliday",
//        async: false,
//        contentType: "application/json; charset=utf-8",
//        dataType: "json",
//        data: JSON.stringify(jsonData),
