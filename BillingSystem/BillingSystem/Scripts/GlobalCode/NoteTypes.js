...
function SaveNoteTypes() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/GlobalCode/AddUpdateNoteTypes",
        data: jsonData,
        dataType: "html",
        beforeSend: function () { },
...
function EditNoteTypes(id) {
    ...
    $.ajax({
        ...
        data: jsonData,
        success: function (data) {
            BindNoteTypesDetailsInEditMode(data);
        },
        error: function (msg) {
        }
    });
...
function DeleteNoteTypes() {
    if ($("#hfGlobalConfirmId").val() > 0) {
        var url = '/GlobalCode/DeleteNoteType';
        $.ajax({
            type: "POST",
            url: url,
            async: false,
...
function BindNoteTypesDetailsInEditMode(data) {
