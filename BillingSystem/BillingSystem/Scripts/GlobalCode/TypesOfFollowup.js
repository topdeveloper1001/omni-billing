...
function ClearTypesOfFollowupForm() {
...
function SaveTypesOfFollowup() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/GlobalCode/AddUpdateTypesOfFollowup",
        data: jsonData,
        dataType: "html",
        beforeSend: function () { },
...
function EditTypesOfFollowup(id) {
    ...
    $.ajax({
        ...
        data: jsonData,
        success: function (data) {
            BindTypesOfFollowupDetailsInEditMode(data);
        },
        error: function (msg) {
        }
    });
...
function DeleteTypesOfFollowup() {
    if ($("#hfGlobalConfirmId").val() > 0) {
        var url = '/GlobalCode/DeleteTypesOfFollowup';
        $.ajax({
            type: "POST",
            url: url,
            async: false,
...
//function DeleteTypesOfFollowup(id) {
...
function BindTypesOfFollowupDetailsInEditMode(data) {
