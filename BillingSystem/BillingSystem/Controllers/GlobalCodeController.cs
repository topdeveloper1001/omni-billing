...
namespace BillingSystem.Controllers
{
    public class GlobalCodeController : BaseController
    {
        ...
        public GlobalCodeController(IUsersService uService, IFacilityService fService, IGlobalCodeService service
            , IGlobalCodeCategoryService gcService, IPhysicianService phService, ICPTCodesService cService)
        {
            _uService = uService;
            _fService = fService;
            _service = service;
