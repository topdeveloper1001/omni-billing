...
namespace BillingSystem.Common
{
    public static class ImageHelper
    {
        ...
        /// <summary>
        /// Writes a simple thumbnail. Suitable up to 150px (for larger, use <see>
        ///                                                                    <cref>WriteThumbnail</cref>
        ///                                                                  </see> )
        /// </summary>
        /// <param name="context">The <see cref="HttpContext"/>.</param>
        /// <param name="filename">The filename.</param>
        ...
        public static Image CreateThumbnailSimple(string filename, int width)
        {
            ...
            using (var bitmap = GetBitmapFromFile(filename))
            {
        ...
        public static Bitmap GetBitmapFromEmbeddedResource(string name)
        {
            ...
            if (stm != null) return new Bitmap(stm);
            return null;
        }
